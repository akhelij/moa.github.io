            ...
            <div class="col-lg-8 m-auto col-md-8 col-sm-12 col-xs-12">
                <div class="main-header-content">
                    ...
                    <p>
                        ...
                        change your password and much more! Also you can create or manage your own favourite page, have fun!
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input class="form-control" placeholder="" type="text"  v-model="profile.user.firstname">
                                </div>

                                <div class="form-group ">
                                    <label class="control-label">Your Email</label>
                                    <input class="form-control" placeholder="" type="email"  v-model="profile.user.email">
                                </div>

                                <div class="form-group date-time-picker ">
                                    <label class="control-label">Your Birthday</label>
                                    <input name="datetimepicker"  v-model=" profile.user.birthday" />
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" placeholder="" type="text"  v-model="profile.user.lastname">
                                </div>

                                <div class="form-group ">
                                    <label class="control-label">Your Website</label>
                                    <input class="form-control" placeholder="" type="text"  v-model="profile.website">
                                </div>


                                <div class="form-group  is-empty">
                                    <label class="control-label">Your Phone Number</label>
                                    <input class="form-control" placeholder="" type="text"  v-model="profile.phone">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group  is-select">
                                    ...
                                    <input class="form-control" placeholder="" type="text"  v-model=" profile.country">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group  is-select">
                                    ...
                                    <input class="form-control" placeholder="" type="text"  v-model="profile.city">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group  is-empty">
                                    <label class="control-label">Your Birthplace</label>
                                    <input class="form-control" placeholder="" type="text"  v-model=" profile.birthplace">
                                </div>


                                <div class="form-group  is-select">
                                    <label class="control-label">Your Gender</label>
                                    <select class="selectpicker form-control"   v-model="profile.user.gender">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" placeholder="" type="text"  v-model="profile.occupation">
                                </div>

                                <div class="form-group  is-select">
                                    <label class="control-label">Status</label>
                                    <select class="selectpicker form-control"  v-model="profile.status">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group ">
                                    ...
                                    <textarea class="form-control" v-model="profile.description" placeholder="Example : Hi, I’m James, I’m 36 and I work as a Digital Designer for the  “Daydreams” Agency in Pier 56">
                                        @{{ profile.description }}
                                    </textarea>
                                </div>
                                <div class="form-group with-icon ">
                                    <input class="form-control" type="text" v-model="profile.facebook">
                                    <i class="fa fa-facebook c-facebook" aria-hidden="true"></i>
                                </div>
                                <div class="form-group with-icon ">
                                    <input class="form-control" type="text"  v-model="profile.twitter">
                                    <i class="fa fa-twitter c-twitter" aria-hidden="true"></i>
                                </div>

                                <div class="form-group with-icon ">
                                    <input class="form-control" type="text"  v-model="profile.instagram">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <input type="button" class="btn btn-primary btn-lg full-width" @click="updateProfile" value="Save all Changes">
                            </div>
...
<script >
    ...
    var app = new Vue({
        ...
        methods:{
            ...
            getProfile:function(){
                axios.get(window.Laravel.url+'/getProfile')
                    .then(response =>{
                ...
                axios.put(window.Laravel.url + '/updateProfile', this.profile)
                    .then(response => {
                    console.log(response.data);
                    if(response.data.etat)
                {
                    this.profile.created_at = response.data.created_at.date.split(".")[0];
                    swal(
                        'Modified!',
...
<!-- Mirrored from theme.crumina.net/html-olympus/28-YourAccount-PersonalInformation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2017 15:58:09 GMT -->
</html>

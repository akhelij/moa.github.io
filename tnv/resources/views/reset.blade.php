			...
			<div class="ui-block">
				...
				<div class="ui-block-content">
					<form class="" method="POST" action="{{url('/changePassword')}}">
						@if(session()->has('success_creation'))
							<div class="alert alert-success" role="alert">{{session()->get('success_creation')}}</div>
						@endif
						@if(session()->has('success_delete'))
							<div class="alert alert-danger" role="alert">{{session()->get('success_delete')}}</div>
						@endif
						{{ csrf_field() }}
...
<!-- Mirrored from theme.crumina.net/html-olympus/30-YourAccount-ChangePassword.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2017 15:58:09 GMT -->
</html>
